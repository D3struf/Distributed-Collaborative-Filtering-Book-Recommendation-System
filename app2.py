...
# from pyspark.sql.types import ArrayType, StringType  # Import both types
...
# book_pivot_df = spark.createDataFrame(book_pivot)
# final_rating_df = spark.createDataFrame(final_rating)
...
# fetch_poster_udf = udf(fetch_poster, ArrayType(StringType()))
